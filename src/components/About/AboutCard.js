      ...
      <Card.Body>
        <blockquote className="blockquote mb-0" data-aos="zoom-in">
          <p style={{ textAlign: "justify"}}>
            Hi Everyone, I am <span className="primary-header">Vinay Yadav</span> from Darbhanga, Bihar, India. I am a computer science graduate and a passionate programmer.
            <br />
            <br />
